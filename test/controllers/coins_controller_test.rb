...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { amount_owned: @coin.amount_owned, cost_per: @coin.cost_per, symbol: @coin.symbol, user_id: @coin.user_id } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { amount_owned: @coin.amount_owned, cost_per: @coin.cost_per, symbol: @coin.symbol, user_id: @coin.user_id } }
